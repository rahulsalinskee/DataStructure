...
namespace Ds.Queue
{
    ...
    {
        private Queue<Employee>? _employees = default;
        private int _id = default;

        public Operation()
        {
            _id = 0;
            _employees = new Queue<Employee>();
        }
        ...
        private IEnumerable<Employee> AddEmployee()
        {
            ...
            _employees?.Enqueue(new Employee() { Id = employee.Id, Name = employee.Name, Age = employee.Age, City = employee.City });
